...
">
  ...
  <ul>
    <li style="color: rgba(0,25,65,0.71);">commit 을 안하고 pull 이나 rebase 등 파일이 지워진 경우</li>
    <li style="color: rgba(0,25,65,0.71);"><strong>인텔리제이 사용하시는 분</strong></li>
    <li style="color: rgba(0,25,65,0.71);">그냥 뻘짓하다가 로컬 파일 삭제한 경우</li>
  </ul>
</div><br><br>
<br>
...
<p align="center" style="font-size: 25px; color: rgba(61,128,255,0.68);"><strong>인텔리제이를 사용하는 경우</strong></p>
<p align="center">
